# Generated by Django 4.1 on 2022-09-01 22:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratingmovie', to='movies.ip_addres', verbose_name='IP адрес')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vote', models.SmallIntegerField(choices=[(1, 'like'), (-1, 'dislike')], verbose_name='Голос')),
                ('Review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likedislikereview', to='movies.review', verbose_name='звезда')),
                ('ip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likedislikereview', to='movies.ip_addres', verbose_name='IP адрес')),
            ],
        ),
    ]
